<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="BookShopping.Account.Register" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table style="width: 100%">
        <tr>
            <td>
                <asp:Image ID="Image2" runat="server" 
                    ImageUrl="~/Imageresources/Icons/adduser.png" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
            <td colspan="2">
                <strong>
                <asp:Label 
                    ...
                    Text=" New Customer Registration&nbsp;" CssClass="lblHeader" Width="442px"></asp:Label>
                </strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator13" 
                    ...
                    ErrorMessage="*Please enter valid name" style="color: #FF0000" 
        ...
        <tr>
            ...
            <td style="height: 26px; color: #FF0000; font-family: 'Comic Sans MS'">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator14" 
                    ...
                    ErrorMessage="*Please enter valid surname" ValidationExpression="^[a-zA-Z\s]+$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 148px; height: 26px;">
        ...
        <tr>
            ...
            <td style="width: 59px; height: 26px;">
                <asp:TextBox ID="txtPhoneNo" runat="server" Width="200px" 
                    CssClass="textfield"></asp:TextBox>
            </td>
            <td style="height: 26px; color: #FF0000; font-family: 'Comic Sans MS'">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                    ControlToValidate="txtPhoneNo" ErrorMessage="*Please enter valid phone no"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator11" 
                    runat="server" ControlToValidate="txtPhoneNo" 
                    ErrorMessage="Please enter numbers(only 10 numbers)" 
        ...
        <tr>
            ...
            <td style="width: 59px">
                <asp:DropDownList ID="DropDownStateList" runat="server" Width="200px" 
                    AutoPostBack="True" 
                    onselectedindexchanged="DropDownStateList_SelectedIndexChanged" 
                    CssClass="dropdownlist" Height="40px" >
            ...
            <td style="color: #FF0000; font-family: 'Comic Sans MS'">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                    ...
                    ControlToValidate="DropDownStateList"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 148px; height: 26px;">
            ...
            <td style="width: 59px; height: 26px;">
                <asp:DropDownList ID="DropDownCityList" runat="server" Width="200px" 
                    AutoPostBack="True" 
                    onselectedindexchanged="DropDownCityList_SelectedIndexChanged" 
                    CssClass="dropdownlist" Height="40px" 
                     >
            ...
            <td style="color: #FF0000; font-family: 'Comic Sans MS'; height: 26px;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                    ...
                    ControlToValidate="DropDownCityList"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 148px">
            ...
            <td style="color: #FF0000; font-family: 'Comic Sans MS'">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator12" 
                    ...
                    ErrorMessage="Please enter numbers(only 6 numbers)" 
        ...
        <tr>
            ...
            <td style="width: 59px">
                <asp:TextBox ID="txtEmailId" runat="server" Width="200px" CssClass="textfield"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            <td style="width: 148px">
                <asp:Label ID="Label14" runat="server" Text="*Password :" CssClass="lblMedium"></asp:Label>
            </td>
            <td style="width: 59px">
        ...
        <tr>
            ...
            <td style="width: 59px">
                <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" 
                    Width="200px" CssClass="textfield"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="width: 59px">
                &nbsp;</td>
            <td>
                <asp:Label ID="lblResult" runat="server" Text="Label" Width="200px"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="3">
                &nbsp;&nbsp;&nbsp;<asp:Button ID="btnSubmit" runat="server" CssClass="brownbtn" 
                    Text="Submit " 
                    onclick="btnSubmit_Click" Height="50px" Width="150px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnReset" runat="server" CssClass="graybtn" Text="Reset" 
                    onclick="btnReset_Click" CausesValidation="False" Height="50px" 
                    Width="150px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
